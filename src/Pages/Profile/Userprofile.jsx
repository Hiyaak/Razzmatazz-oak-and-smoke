      ...
      <div className='w-full md:w-[42%] h-screen border-r border-gray-200 flex flex-col relative'>
        ...
        {showAddressModal && (
          <div
            ...
            onClick={() => setShowAddressModal(false)} // ✅ close when clicking background
          >
            <div
          ...
          >
            ...
            >
              ...
              <input
                ...
                className='w-full border-b border-gray-300 outline-none focus:border-gray-500 pb-1 placeholder:text-gray-400 text-sm mb-6'
              />
